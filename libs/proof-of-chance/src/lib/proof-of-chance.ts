...
export class ProofOfChance {
  ...
  private getChanceInHex() {
    return Crypto.stringToHexString(
      this.chance,
      ProofOfChance.CHANCE_MAX_LENGTH
    );
  }
  ...
  async toFileContent() {
    ...
    Cryptography Detail:
    - Your chance in Hex format: ${this.getChanceInHex()}
